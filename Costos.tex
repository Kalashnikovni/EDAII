...
contraer $lg \;\vert as \vert$ veces, y la máxima profundidad de las aplicaciones
del argumento primero sobre el orden de reducción dado por sus llamadas recursivas.
